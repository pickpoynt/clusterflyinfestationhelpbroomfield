      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <span className="font-heading font-bold text-xl block leading-none tracking-tight text-white uppercase">Chino Hills Clogged Drain</span>
                <span className="text-sm font-medium text-amber-500 uppercase tracking-widest text-[10px]">Cleaning Professional</span>
              </div>
            </div>
            <p className="text-slate-400 mb-8 leading-relaxed font-medium italic">
              Chino Hills' rapid-response drain cleaning team. We provide safe, effective blockage removal and professional hydro jetting throughout Chino Hills and the surrounding San Bernardino County area.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["Emergency Unclogging", "Hydro Jetting", "Main Sewer Cleaning", "Video Inspection", "Rooter Service"].map((item) => (
                <li key={item}>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <address className="text-slate-400 not-italic font-medium leading-relaxed">
                  Chino Hills Clogged Drain Cleaning Pros<br />
        ...
        <div className="pt-12 border-t border-slate-800 text-center">
          <p className="text-slate-500 text-sm font-medium italic mb-4">
            © {new Date().getFullYear()} Chino Hills Clogged Drain Cleaning Pros. All rights reserved. Professional Drain Services Chino Hills, CA.
          </p>
          <div className="max-w-4xl mx-auto px-4 text-center">
            <p className="text-slate-400 text-xs mb-4">
              For support or inquiries, please email <a href="mailto:leasemynumber@gmail.com" className="text-amber-500 hover:underline tracking-tight">LEASE MY NUMBER</a> and link it to <a href="/lease-my-number" className="text-amber-500 hover:underline tracking-tight">LEASE PAGE</a>
            </p>
